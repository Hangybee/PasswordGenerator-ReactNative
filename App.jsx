...
const App = () => {
  ...
  const createPassword = (characters, passwordLength) => {
    ...
    for (let i = 0; i < passwordLength; i++) {
      ...
      console.log('maaaaaaaaaaaa', characterIndex);
    ...
    <ScrollView keyboardShouldPersistTaps="handled">
      <SafeAreaView style={styles.appContainer}>
              ...
              <>
                ...
                <View style={styles.inputWrapper}>
                  <Text style={styles.heading}>
                    Includes Uppercase lettersercase
                  </Text>
                  <BouncyCheckbox
                    disableBuiltInState
                    isChecked={upperCase}
        ...
        <View style={{flexDirection:'row'}}>
          <Text style={{color:'gray',  marginLeft:10 }}>Describe us how you like this app by </Text>
          <TouchableOpacity onPress={()=>Linking.openURL(`mailto:mayankbankoti28@gmail.com?subject=rating&body=hi`)} >
            <Text style={{fontWeight:'bold',}}>pressing here</Text>
          </TouchableOpacity>
          </View>
        </SafeAreaView>
    </ScrollView>
